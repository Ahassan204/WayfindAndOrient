...
import static com.example.hamsajama.wayfindandorient.util.Constants.INVALID_FLOAT_VALUE;
import static com.example.hamsajama.wayfindandorient.util.Constants.INVALID_INT_VALUE;
import static com.example.hamsajama.wayfindandorient.util.Constants.INVALID_LONG_VALUE;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_LATITUDE;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_LONGITUDE;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_RADIUS;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_EXPIRATION_DURATION;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_TRANSITION_TYPE;
import static com.example.hamsajama.wayfindandorient.util.Constants.KEY_PREFIX;
