...
/**
 * Created by hamsajama on 28/07/2016.
 */
public final class Constants {
    ...
    public static final double ANDROID_BUILDING_LATITUDE = 51.570207;
    public static final double ANDROID_BUILDING_LONGITUDE = -0.271443;
